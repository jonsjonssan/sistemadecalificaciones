...
<body>
  ...
  return (
    <Card className={`shadow-sm ${darkMode ? 'bg-[#121E32] border-slate-700' : 'border-emerald-100'}`}>
                ...
                <Table className="text-xs sm:text-sm font-medium">
                  ...
                  <TableBody>
                    {activeStudents.map((est, idx) => {
                      ...
                      const rowBg = evenRow ? (darkMode ? 'bg-[#121E32]' : '') : (darkMode ? 'bg-slate-800/50' : 'bg-slate-50/50');
                      const stickyBg = evenRow ? (darkMode ? 'bg-[#121E32]' : 'bg-white') : (darkMode ? 'bg-slate-800/50' : 'bg-slate-50/50');
      ...
      <Dialog open={bloqueoDialogOpen} onOpenChange={setBloqueoDialogOpen}>
        <DialogContent className={`max-w-sm ${darkMode ? 'bg-[#121E32] border-slate-700' : ''}`}>
          <DialogHeader>
