      ...
      <Card className={`shadow-sm border ${darkMode ? "bg-card border-slate-700" : "bg-white border-slate-200"}`}>
        <CardContent className="p-2 sm:p-3">
          <div className="flex flex-wrap items-end gap-2 sm:gap-3">
            ...
            {gradoId && (
              <>
                <Button size="sm" variant="outline" onClick={exportarCSV} className={`h-11 sm:h-12 text-sm ${darkMode ? "bg-card border-white/30 text-white hover:bg-white/10" : ""}`}>
                  <Download className="h-4 w-4 sm:h-5 sm:w-5 sm:mr-1" /><span className="hidden sm:inline">Excel (CSV)</span>
                </Button>
                <Button size="sm" variant="outline" onClick={exportarPDF} className={`h-11 sm:h-12 text-sm ${darkMode ? "bg-card border-white/30 text-white hover:bg-white/10" : ""}`}>
