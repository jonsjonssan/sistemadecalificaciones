...
const ReporteCalificaciones = memo(function ReporteCalificaciones({ grados, darkMode, todasAsignaturas, umbralCondicionado = 4.5, umbralAprobado = 6.5 }: ReporteCalificacionesProps) {
  ...
  if (!grados || grados.length === 0) {
    return (
      <Card className={`shadow-sm border ${darkMode ? "bg-[#18181C] border-slate-700 text-white" : "bg-white border-slate-200"}`}>
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Selectores */}
      <Card className={`shadow-sm border ${darkMode ? "bg-[#18181C] border-slate-700" : "bg-white border-slate-200"}`}>
      ...
      {!gradoId ? (
        ...
        <>
          ...
          {/* Tabla */}
          <Card className={`shadow-xl border overflow-hidden ${darkMode ? "bg-[#18181C] border-slate-700 text-white" : "bg-white border-slate-200"}`}>
