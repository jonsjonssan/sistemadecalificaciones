...
export async function POST() {
  ...
  try {
    ...
    const materiasPorGrado: Record<number, string[]> = {
      2: ["Comunicación y Literatura", "Números y Formas", "Ciudadanía y Valores", "Ciencia y Tecnología", "Desarrollo Corporal", "Educación en la Fe", "Artes"],
      3: ["Comunicación y Literatura", "Números y Formas", "Ciudadanía y Valores", "Ciencia y Tecnología", "Desarrollo Corporal", "Educación en la Fe", "Artes"],
      ...
      7: ["Comunicación y Literatura", "Matemática y Datos", "Ciudadanía y Valores", "Ciencia y Tecnología", "Educación Física y Deportes", "Educación en la Fe", "Artes", "Inglés"],
      8: ["Comunicación y Literatura", "Matemática y Datos", "Ciudadanía y Valores", "Ciencia y Tecnología", "Educación Física y Deportes", "Educación en la Fe", "Artes", "Inglés"],
      9: ["Comunicación y Literatura", "Matemática y Datos", "Ciudadanía y Valores", "Ciencia y Tecnología", "Educación Física y Deportes", "Educación en la Fe", "Artes", "Inglés"],
    };
    ...
    const asignacionesDocentes = [
      ...
      { email: "04876579-1@clases.edu.sv", tutorGrado: 3, materias: [{ grado: 3, mat: "Comunicación y Literatura" }, { grado: 3, mat: "Números y Formas" }, { grado: 3, mat: "Ciudadanía y Valores" }, { grado: 3, mat: "Ciencia y Tecnología" }] },
      ...
      { email: "deysi.elizabeth.umanzor@clases.edu.sv", tutorGrado: 2, materias: [{ grado: 2, mat: "Comunicación y Literatura" }, { grado: 2, mat: "Números y Formas" }, { grado: 2, mat: "Ciudadanía y Valores" }, { grado: 2, mat: "Ciencia y Tecnología" }] },
